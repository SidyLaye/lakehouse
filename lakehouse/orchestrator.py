...
SMTP_USER    = os.getenv('SMTP_USER',  'sarrsidylaye@gmail.com')
SMTP_PASS    = os.getenv('SMTP_PASS',  'hjrsaafooovinydz')
ALERT_EMAIL  = os.getenv('ALERT_EMAIL', SMTP_USER)

_raw_es_host = os.getenv('ES_HOST', 'http://elasticsearch:9200')
