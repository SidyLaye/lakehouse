...
public interface SqlBaseParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitPercentile(SqlBaseParser.PercentileContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCreateOrReplaceTableColTypeList(SqlBaseParser.CreateOrReplaceTableColTypeListContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#createOrReplaceTableColType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCreateOrReplaceTableColType(SqlBaseParser.CreateOrReplaceTableColTypeContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGenerationExpression(SqlBaseParser.GenerationExpressionContext ctx);
	/**
